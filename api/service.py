...
class Auth:
    ...
    def __init__(self): #método init o py reconhece que o método inicializador da classe
        self.__base_url='https://donatodev.pythonanywhere.com/api/v1/' #a pep 8 recomenda que quando o método for utilizado somente dentro da própria classe, se começa com __ dois underline
